...
function BarberTab({visits,emps,svcs,user,supabase,sc,S,SB,money,todayStr,logAct,push,setVisits,queueEnabled,setQueueEnabled,saving,setSaving,barberQueueNum,setBarberQueueNum}){
  ...
  return<div>
    ...
    {/* Registration form */}
    {showReg&&<div style={{background:"#FEFCF9",border:"1px solid #E8E4DF",borderRadius:12,padding:18,marginBottom:12,boxShadow:"0 4px 20px rgba(15,30,51,0.08)"}}>
...
// ── Commission Excel Export — organized, professional, easy to read ──
  ...
  >
    ...
    {offline&&<div style={{background:"#b45309",color:"#fff",textAlign:"center",padding:8,fontSize:13,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",gap:7}}><AlertTriangle size={14}/> Offline — changes will not save</div>}
...
function EMP({children}){return <div style={{padding:32,textAlign:"center",color:"#9CA3AF",fontSize:13,lineHeight:1.6,background:"#FAF8F4",borderRadius:10,border:"1px dashed #DDD8D0"}}>{children}</div>;}
