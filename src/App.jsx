...
const FS=[
  ...
  {id:221,cat:"Beauty Salon",sub:"Nails",  name:"የጥፍር ፍላወር (ትንሽ)",price:10,cm:0,es:"Beauty Salon",bk:false,dm:10},
  {id:222,cat:"Beauty Salon",sub:"Nails",  name:"የጥፍር ፍላወር (መካከለኛ)",price:30,cm:0,es:"Beauty Salon",bk:false,dm:15},
  {id:223,cat:"Beauty Salon",sub:"Nails",  name:"የጥፍር ፍላወር (ትልቅ)",price:50,cm:0,es:"Beauty Salon",bk:false,dm:15},
  {id:224,cat:"Beauty Salon",sub:"Nails",  name:"የጥፍር ፍሬሮች (1)",price:10,cm:0,es:"Beauty Salon",bk:false,dm:5},
  {id:225,cat:"Beauty Salon",sub:"Nails",  name:"የጥፍር ፍሬሮች (2)",price:20,cm:0,es:"Beauty Salon",bk:false,dm:5},
  {id:226,cat:"Beauty Salon",sub:"Nails",  name:"የጥፍር ፍሬሮች (3)",price:30,cm:0,es:"Beauty Salon",bk:false,dm:5},
  ...
  {id:319,cat:"Beauty Salon",sub:"Braids", name:"ስ ግስ ግ ስፌት",price:1000,cm:10,es:"Beauty Salon",bk:false,dm:120},
  {id:320,cat:"Beauty Salon",sub:"Braids", name:"ሒይማን መፍቻ",price:200,cm:0,es:"Beauty Salon",bk:false,dm:20},
  {id:321,cat:"Beauty Salon",sub:"Braids", name:"½ ስፌት ½ ሸሩባ",price:1500,cm:10,es:"Beauty Salon",bk:false,dm:120},
  {id:322,cat:"Beauty Salon",sub:"Braids", name:"ስዋስዋ ስፌት",price:1000,cm:10,es:"Beauty Salon",bk:false,dm:120},
  {id:323,cat:"Beauty Salon",sub:"Braids", name:"ካንቱ ፍሬዝ በሒይማን",price:700,cm:0,es:"Beauty Salon",bk:false,dm:30},
  ...
  {id:608,cat:"Beauty Salon",sub:"Wax",    name:"ካንቱ ፈረዘ",             price:700, cm:0,es:"Beauty Salon",bk:false,dm:30},
  {id:609,cat:"Beauty Salon",sub:"Wax",    name:"ኮንዶበት ፈረዘ ከኛ",price:700,cm:0,es:"Beauty Salon",bk:false,dm:30},
  {id:701,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ",price:2800,cm:10,es:"Spa",bk:true,dm:120},
  {id:702,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + በቆሎ ዱቄት እና ማር",price:3000,cm:10,es:"Spa",bk:true,dm:120},
  {id:703,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + አኩሪ አተር ዱቄት እና ማር",price:3000,cm:10,es:"Spa",bk:true,dm:120},
  {id:704,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + አኩሪ አተር ፣ አርጎ ፣ ወይራ ዘይት",price:3000,cm:10,es:"Spa",bk:true,dm:120},
  {id:705,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + ጥቁር አዝሙድ ፣ ወይራ ዘይት",price:3500,cm:10,es:"Spa",bk:true,dm:120},
  {id:706,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + ፍራፍሬ ፣ ማር ፣ አርጎ ፣ የታመሰ አርድ",price:3500,cm:10,es:"Spa",bk:true,dm:120},
  {id:707,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + አጃ ፣ ማር ፣ አርጎ ፣ የታመሰ አርድ",price:3500,cm:10,es:"Spa",bk:true,dm:120},
  {id:708,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + ቡና ፣ ማር ፣ አርጎ",price:4000,cm:10,es:"Spa",bk:true,dm:120},
  {id:709,cat:"Spa",sub:"Moroccan Bath",name:"ሞሮኮ ባዝ + ራዝ ፣ ማር ፣ አርጎ ፣ ወይራ ዘይት +15 ደቂቃ ማሳጅ",price:4500,cm:10,es:"Spa",bk:true,dm:135},
  {id:710,cat:"Spa",sub:"Moroccan Bath",name:"አምባር ስፔሻል - ሞሮኮ ባዝ + ቀረፋ ፣ አቢሽ ፣ ቡና ፣ ማር ፣ አርጎ ፣ ሰሊጥ ፣ ፍራፍሬ + የጀሮ ሕክምነት + 30 ደቂቃ ማሳጅ + የጸጉር ስራ/ቅርጥፎ",price:5000,cm:10,es:"Spa",bk:true,dm:180},
  {id:801,cat:"Spa",sub:"Steam & Sauna",name:"Steam & Sauna 2hrs",                         price:1000,cm:0, es:"Spa",bk:true,dm:120},
  {id:802,cat:"Spa",sub:"Steam & Sauna",name:"Couple Steam & Sauna 2hrs + 1 Juice",        price:4000,cm:0, es:"Spa",bk:true,dm:120},
  ...
  {id:909,cat:"Spa",sub:"Massage",name:"Coffee Scrub & Honey Massage 60min + 1 Juice",price:3000,cm:10,es:"Spa",bk:true,dm:60},
  ...
  {id:912,cat:"Spa",sub:"Massage",name:"Couple Massage Regular 60min",price:4000,cm:10,es:"Spa",bk:true,dm:60},
  {id:913,cat:"Spa",sub:"Massage",name:"Couple Massage Special (60min Steam+Sauna + 60min Massage + 1 Juice)",price:7000,cm:10,es:"Spa",bk:true,dm:180},
  {id:914,cat:"Spa",sub:"Massage",name:"Japanese Massage",price:1650,cm:10,es:"Spa",bk:true,dm:60},
  {id:915,cat:"Spa",sub:"Massage",name:"Nerve Massage",price:1400,cm:10,es:"Spa",bk:true,dm:60},
  {id:916,cat:"Spa",sub:"Massage",name:"Yoga Massage",price:1600,cm:10,es:"Spa",bk:true,dm:60},
];
...
function gregToEth(gDate){if(!gDate)return{y:0,m:0,d:0};const d=new Date(gDate);const jdn=Math.floor(d.getTime()/86400000)+2440588;const r=jdn-1723856;const n=Math.floor(r/1461);const r2=r%1461;const m2=Math.floor(r2/365);const d2=r2%365;const ey=4*n+m2+(d2===0&&m2===4?-1:0);const rem=r2-(m2<4?m2*365:4*365);const em=Math.floor(rem/30)+1;const ed=rem%30+1;return{y:ey,m:Math.min(em,13),d:Math.min(ed,30)};}
function ethToGreg(ey,em,ed){const jdn=1723856+(ey-1)*365+Math.floor(ey/4)+(em-1)*30+ed;const l=jdn+68569;const n=Math.floor(4*l/146097);const l2=l-Math.floor((146097*n+3)/4);const i=Math.floor(4000*(l2+1)/1461001);const l3=l2-Math.floor(1461*i/4)+31;const j=Math.floor(80*l3/2447);const dd=l3-Math.floor(2447*j/80);const l4=Math.floor(j/11);const mm=j+2-12*l4;const yy=100*(n-49)+i+l4;return`${yy}-${String(mm).padStart(2,"0")}-${String(dd).padStart(2,"0")}`;}
...
function checkConflict(bks,form,svcs){
  ...
  if(svc.sub==="Moroccan Bath"){const oth=overlap.filter(b=>b.serviceCategory==="Spa"&&b.serviceName.includes("ሞሮኮ"));const tot=oth.reduce((s,b)=>s+b.people,0)+Number(form.people||1);if(tot>4)return"⚠️ Moroccan Bath may be over capacity (max 4). Confirm with customers.";}
  if(svc.sub==="Steam & Sauna"&&overlap.filter(b=>b.serviceCategory==="Spa"&&b.serviceName.includes("Sauna")).length>0)return"⚠️ Steam & Sauna has overlapping bookings. Check availability.";
  if(svc.sub==="Massage"&&overlap.filter(b=>b.serviceCategory==="Spa"&&b.serviceName.includes("Massage")).length>=2)return"⚠️ Both massage rooms may be occupied at this time.";
  return null;}

function Notifs({items,dismiss}){if(!items.length)return null;return <div style={{position:"fixed",top:0,left:0,right:0,zIndex:9999,padding:"8px",pointerEvents:"none",display:"flex",flexDirection:"column",gap:4}}>{items.map(n=><div key={n.id} style={{background:n.type==="success"?"#166534":n.type==="warning"?"#92400e":"#1e40af",color:"#fff",borderRadius:12,padding:"11px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",boxShadow:"0 4px 20px rgba(0,0,0,0.3)",pointerEvents:"all",maxWidth:460,margin:"0 auto",width:"calc(100% - 16px)"}}><span style={{fontWeight:700,fontSize:13}}>{n.msg}</span><button onClick={()=>dismiss(n.id)} style={{background:"none",border:"none",color:"#fff",cursor:"pointer",fontSize:18,marginLeft:12}}>x</button></div>)}</div>;}
...
export default function App(){
  ...
  useEffect(()=>{
    const t=setInterval(async()=>{
      ...
      if(now.getHours()>=CLOSE_HOUR){
        ...
        for(const v of stale){await supabase.from("visits").update({status:"Cancelled",note:(v.note||"")+" [Auto-closed end of day]"}).eq("id",v.id);}
      }
    },60000);
  ...
  // Realtime — instant sync all devices
  useEffect(()=>{
    if(!user)return;
    const role=user.role;const uid=user.id+Date.now();
    const vs=supabase.channel("v"+uid)
      ...
      .subscribe();
    const bs=supabase.channel("b"+uid)
      .on("postgres_changes",{event:"INSERT",schema:"public",table:"bookings"},p=>{
        ...
        if(role===ROLES.SUPERVISOR||role===ROLES.MANAGER)push("📅 Booking: "+p.new.customer_name+" at "+p.new.time,"info");
      })
      ...
      .subscribe();
    const es=supabase.channel("e"+uid)
  ...
  function recall(){const f=custs.find(c=>c.phone===rPhone.trim());if(f){setRName(f.name);setRmsg("✓ Found: "+f.name+" ("+f.totalVisits+" visits)");}else setRmsg("New customer — not in system");}
  ...
  async function addSvc(){
    ...
    await supabase.from("visits").update({services:upd,total_service:upd.reduce((s,l)=>s+lineIncome(l),0),status:"In Service"}).eq("id",act.id);
    setSvSvcId("");
  }

  async function updLine(vid,lid2,f,v){
    const vis=visits.find(x=>x.id===vid);if(!vis)return;
    const tf=["employee","preferredEmployee","status"];
    const nv=tf.includes(f)?v:f==="free"?v:Number(v)||0;
  ...
  async function markReady(){
    if(!act||!act.services.length)return alert("No services added.");
    const p=act.services.find(l=>!["Completed","Cancelled"].includes(l.status));if(p)return alert("Complete or cancel: "+p.name);
    const m=act.services.find(l=>l.status!=="Cancelled"&&!l.employee);if(m)return alert("Assign employee for: "+m.name);
    await supabase.from("visits").update({status:"Ready for Payment"}).eq("id",act.id);
  ...
  async function confirmPay(grp=false){
    ...
    for(const id of ids){const v=visits.find(x=>x.id===id);const mt=id===act.id?tips:[];const mtt=mt.reduce((s,t)=>s+Number(t.amount||0),0);await supabase.from("visits").update({tips:mt,total_paid:v.totalService+mtt,payment_method:payM,status:"Paid & Closed"}).eq("id",id);}
    logAct(user,"Payment",act.name+" "+payM);setTips([]);setActId(null);
  }
  ...
  async function checkIn(b){
    if(!window.confirm("Check in "+b.customerName+"? This will create a queue entry."))return;
    setSaving(true);const cid=makeId(b.customerName,b.customerPhone);
    const tc=visits.filter(v=>v.date===todayStr()).length;
    const vr={id:Date.now(),date:todayStr(),queue:tc+1,customer_id:cid,name:b.customerName,payer_name:b.customerName,phone:b.customerPhone,group_id:null,group_name:"",services:[],total_service:0,total_paid:0,payment_method:"",tips:[],status:"Waiting for Supervisor",note:"Booking: "+b.serviceName};
    await supabase.from("visits").insert(vr);
    await supabase.from("bookings").update({status:"Arrived",visit_id:vr.id}).eq("id",b.id);
    logAct(user,"Check-in",b.customerName);setSaving(false);push(b.customerName+" checked in — Queue #"+vr.queue,"success");
  }
  ...
  async function delE(id){if(!window.confirm("Delete this expense?"))return;await supabase.from("expenses").delete().eq("id",id);setExps(p=>p.filter(e=>e.id!==id));}
  ...
  async function closePeriod(){if(!window.confirm("Close pay period "+period.label+"? This will reset all deductions."))return;const snap=empC.map(e=>({id:e.id,name:e.name,section:e.section,salary:e.salary,commissionTotal:e.commissionTotal,absentDays:e.absentDays,loan:e.loan,brokerFee:e.brokerFee,otherDeduction:e.otherDeduction,loanNote:e.loanNote,otherNote:e.otherNote}));await supabase.from("closed_periods").insert({period:period.label,start_date:period.start,end_date:period.end,closed_at:new Date().toISOString(),employees:snap});for(const e of emps)await supabase.from("employees").update({absent_days:0,loan:0,loan_note:"",broker_fee:0,other_deduction:0,other_note:""}).eq("id",e.id);setEmps(p=>p.map(e=>({...e,absentDays:0,loan:0,loanNote:"",brokerFee:0,otherDeduction:0,otherNote:""})));logAct(user,"Closed period",period.label);alert("Period closed successfully.");}
  async function saveStaff(){if(!nStaff.id.trim()||!nStaff.name.trim()||!nStaff.password.trim())return alert("Fill all fields.");const r={id:nStaff.id.trim().toLowerCase(),name:nStaff.name.trim(),role:nStaff.role,password:nStaff.password.trim(),active:true};await supabase.from("staff").upsert(r);setStaff(p=>{const i=p.findIndex(s=>s.id===r.id);if(i>=0){const n=[...p];n[i]=r;return n;}return[...p,r];});logAct(user,"Staff saved",r.name);setNStaff({id:"",name:"",role:"reception",password:""});setEditStaff(null);}
  ...
  async function delCust(id){if(!window.confirm("Delete this customer permanently?"))return;await supabase.from("customers").delete().eq("id",id);setCusts(p=>p.filter(c=>c.id!==id));}
  ...
  if(user&&pinLocked)return(
    <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"linear-gradient(135deg,#0f1720,#1d2a36)",fontFamily:"Segoe UI,sans-serif"}}>
      <div style={{background:"#fff",borderRadius:24,padding:"40px",width:"100%",maxWidth:340,margin:"0 16px",boxShadow:"0 20px 60px rgba(0,0,0,0.4)",textAlign:"center"}}>
        ...
        <p style={{color:"#6b7280",fontSize:13,marginBottom:20}}>Re-enter your password to continue as {user.name}</p>
        {pinErr&&<div style={{background:"#fee2e2",color:"#991b1b",borderRadius:10,padding:10,marginBottom:12,fontSize:13,fontWeight:700}}>{pinErr}</div>}
  ...
  return(<div style={{minHeight:"100vh",background:"linear-gradient(135deg,#0f1720 0%,#1d2a36 38%,#f6efe3 38%,#fffaf2 100%)",fontFamily:"Segoe UI,Arial,sans-serif",color:"#111827"}}>
    ...
    <div style={{maxWidth:1400,margin:"0 auto",padding:sc.mob?"12px":"28px"}}>
      ...
      <header style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",color:"white",marginBottom:14,flexWrap:"wrap",gap:8}}>
        <div>
          <p style={{color:"#e0b85a",fontWeight:900,letterSpacing:2,margin:"0 0 4px",fontSize:11}}>AMBAR SPA & BEAUTY</p>
          {!sc.mob&&<h1 style={{margin:0,fontSize:24,fontWeight:900}}>Salon Management System</h1>}
          <p style={{color:"#f8ead4",fontSize:12,margin:"4px 0 0"}}>{user.name} <span style={{background:"#e0b85a",color:"#111827",borderRadius:6,padding:"1px 8px",fontSize:10,fontWeight:800,marginLeft:4}}>{user.role}</span><button onClick={logout} style={{background:"transparent",border:"1px solid #e0b85a",color:"#e0b85a",borderRadius:8,padding:"2px 10px",cursor:"pointer",fontSize:11,marginLeft:8}}>Logout</button></p>
        </div>
        <div style={{background:"#e0b85a",color:"#111827",borderRadius:16,padding:"10px 18px",textAlign:"center"}}>
          <p style={{margin:0,fontSize:10,fontWeight:800}}>TODAY NEXT</p>
          <h2 style={{margin:"2px 0 0",fontSize:26,fontWeight:900}}>#{todayV.length+1}</h2>
        </div>
      </header>

      {sc.mob?(
        <div style={{marginBottom:10}}>
          <button onClick={()=>setMobNav(v=>!v)} style={{...S.btnS,marginBottom:0}}>☰ {tab}</button>
          {mobNav&&<div style={{background:"#fff",borderRadius:14,padding:10,marginTop:6,border:"1px solid #e6c977"}}>
            {allTabs.map(t=><button key={t} style={{...tab===t?S.tabA:S.tab,display:"block",width:"100%",marginBottom:4,textAlign:"left"}} onClick={()=>{setTab(t);setMobNav(false);}}>{t}</button>)}
          </div>}
        </div>
      ):(
        <>
      ...
      {tab==="Reception"&&<main style={{display:"grid",gridTemplateColumns:gc,gap:14}}>
        <section style={S.card}>
          <h2 style={S.ct}>Register Customer</h2>
          <L>Phone *</L>
          <div style={S.r2}><input style={S.inp} value={rPhone} onChange={e=>setRPhone(e.target.value)} onKeyDown={e=>e.key==="Enter"&&recall()} placeholder="Phone number"/><button style={S.btnS} onClick={recall}>Recall</button></div>
          ...
          <HR/>
          <h3 style={{margin:"0 0 8px",fontSize:13,fontWeight:800,color:"#6b4c11"}}>Quick Daily Expense</h3>
        ...
        <section style={S.card}>
          <h2 style={S.ct}>Today's Queue — {new Date().toLocaleDateString("en-GB",{weekday:"long",day:"numeric",month:"long"})}</h2>
          {todayV.length===0&&<EMP>No customers registered yet today.</EMP>}
          {todayV.map(v=><div key={v.id} style={S.li}>
            <div><b style={{fontSize:15}}>#{v.queue} — {v.name}</b>{v.groupName&&<p style={S.hlp}>{v.groupName}</p>}{v.note&&<p style={S.hlp}>📝 {v.note}</p>}</div>
      ...
      {tab==="Supervisor"&&<main style={{display:"grid",gridTemplateColumns:gc,gap:14}}>
        <section style={S.card}>
          <h2 style={S.ct}>Queue Overview</h2>
          <h3 style={S.sh}>⏳ Waiting for Service</h3>
          {visits.filter(v=>v.status==="Waiting for Supervisor"&&v.date===todayStr()).length===0
            ?<p style={S.hlp}>No one waiting.</p>
            :visits.filter(v=>v.status==="Waiting for Supervisor"&&v.date===todayStr()).map(v=>
              <button key={v.id} style={actId===v.id?S.liA:S.liB} onClick={()=>setActId(v.id)}>
                <span><b>#{v.queue} — {v.name}</b>{v.note&&<span style={{...S.hlp,marginLeft:8}}>({v.note})</span>}</span>
                <span style={SB("Waiting for Supervisor")}>New</span>
              </button>
          )}
          <HR/>
          <h3 style={S.sh}>🔄 Active Services</h3>
          {svcQ.length===0&&<p style={S.hlp}>No active service queues.</p>}
          {svcs.map(svc=>{const rows=svcQ.filter(r=>r.line.serviceId===svc.id);if(!rows.length)return null;return(
            <div key={svc.id} style={{background:"#fefaf0",border:"1px solid #ecdba3",borderRadius:12,padding:10,marginBottom:8}}>
              <b style={{fontSize:13}}>{svc.name}</b><span style={{...S.hlp,marginLeft:8}}>{rows.length} in queue</span>
              {rows.map(({visit:vv,line})=><button key={line.lineId} style={actId===vv.id?S.liA:S.liB} onClick={()=>setActId(vv.id)}>
                <span>#{vv.queue} — {vv.name}</span><span style={SB(line.status)}>{line.status}</span>
              </button>)}
            </div>
          );})}
        </section>
        <section style={S.card}>
          {!act?<EMP>← Select a customer from the queue to begin.</EMP>:<>
            ...
            {act.status==="Ready for Payment"&&<div style={{background:"#fef9ec",border:"1px solid #e0b85a",borderRadius:11,padding:12,marginBottom:10,fontSize:13}}>Customer is ready for checkout.<button style={{...S.btnS,marginTop:8,width:"auto",padding:"8px 14px"}} onClick={reopen}>Reopen for editing</button></div>}
            {!["Paid & Closed","Ready for Payment"].includes(act.status)&&<>
              <div style={S.r2}>
                <select style={S.inp} value={svCat} onChange={e=>{setSvCat(e.target.value);setSvSub("All");setSvSvcId("");}}>{cats.map(c=><option key={c}>{c}</option>)}</select>
                <select style={S.inp} value={svSub} onChange={e=>{setSvSub(e.target.value);setSvSvcId("");}}>{svSubs.map(x=><option key={x}>{x}</option>)}</select>
              </div>
              <select style={S.inp} value={svSvcId} onChange={e=>setSvSvcId(e.target.value)}>
                <option value="">Select a service...</option>
                {svAvail.map(s=><option key={s.id} value={String(s.id)}>{s.name} — {money(s.price)}</option>)}
              </select>
      ...
      {tab==="Checkout"&&<main style={{display:"grid",gridTemplateColumns:gc,gap:14}}>
        <section style={S.card}>
          <h2 style={S.ct}>Checkout</h2>
          <input style={S.inp} placeholder="Search by queue #, name or phone..." value={coQ} onChange={e=>setCoQ(e.target.value)}/>
          {coList.length===0&&<p style={S.hlp}>No results.</p>}
          {coList.map(v=><button key={v.id} style={actId===v.id?S.liA:S.liB} onClick={()=>setActId(v.id)}>
            <span>#{v.queue} — {v.name}</span>
            <span style={SB(v.status)}>{v.status==="Ready for Payment"?"Ready — "+money(v.totalService):v.status}</span>
          </button>)}
        </section>
        <section style={S.card}>
          {!act?<EMP>← Select a customer to process payment.</EMP>
           :act.status==="Paid & Closed"?<div style={{background:"#dcfce7",color:"#166534",borderRadius:11,padding:16,fontSize:15,fontWeight:700}}>✓ Paid — {money(act.totalPaid)} via {act.paymentMethod}</div>
           :<>
            ...
            <HR/>
            <h3 style={{margin:"0 0 4px",fontWeight:800}}>Tips</h3>
            <p style={S.hlp}>Tips go directly to employees and are not counted as revenue.</p>
            <div style={S.r2}>
              <select style={S.inp} value={tipEmp} onChange={e=>setTipEmp(e.target.value)}><option value="">Select employee</option>{emps.filter(e=>e.active).map(e=><option key={e.id}>{e.name}</option>)}</select>
              <input style={S.inp} type="number" value={tipAmt} onChange={e=>setTipAmt(e.target.value)} placeholder="Tip amount (Birr)"/>
            </div>
            <button style={S.btnS} onClick={addTip}>+ Add Tip</button>
            {tips.map(t=><div key={t.id} style={S.li}><span>{t.employee}</span><span style={{display:"flex",alignItems:"center",gap:8}}><b>{money(t.amount)}</b><button style={S.btnD} onClick={()=>setTips(p=>p.filter(x=>x.id!==t.id))}>×</button></span></div>)}
            <HR/>
            <L>Payment Method</L>
      ...
      {tab==="Bookings"&&<section style={S.card}>
        ...
        {showBkF&&user.role!=="supervisor"&&<div style={{background:"#fffaf2",border:"1px solid #e0b85a",borderRadius:16,padding:18,marginBottom:16}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:sc.mob?"1fr":"1fr 1fr",gap:10}}>
            ...
            <div><L>Phone *</L><div style={S.r2}><input style={S.inp} value={bkF.customerPhone} onChange={e=>setBkF(p=>({...p,customerPhone:e.target.value}))} placeholder="Phone"/><button style={S.btnS} onClick={()=>{const f=custs.find(c=>c.phone===bkF.customerPhone.trim());if(f)setBkF(p=>({...p,customerName:f.name}));else alert("Not in system");}}>Recall</button></div></div>
            <div><L>Service *</L>
              <select style={S.inp} value={String(bkF.serviceId)} onChange={e=>{const sid=e.target.value;const warn=checkConflict(bks,{...bkF,serviceId:sid},svcs);setBkWarn(warn||"");setBkF(p=>({...p,serviceId:sid}));}}>
            ...
            <div><L>Time * (Ethiopian: {toEthTime(bkF.time)})</L>
              <select style={S.inp} value={bkF.time} onChange={e=>setBkF(p=>({...p,time:e.target.value}))}>
                {timeSlots().map(t=><option key={t} value={t}>{t} ({toEthTime(t)})</option>)}
              </select>
            </div>
            ...
            <div style={{gridColumn:"1/-1"}}><L>Notes / Special Requests</L><textarea style={S.ta} value={bkF.notes} onChange={e=>setBkF(p=>({...p,notes:e.target.value}))}/></div>
          </div>
        ...
        {todayBk.map(b=>{const c=BKC[b.status]||{bg:"#f3f4f6",co:"#374151"};return(
          <div key={b.id} style={{...S.li,flexWrap:"wrap",gap:10,alignItems:"flex-start"}}>
            <div style={{flex:1,minWidth:200}}>
              <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:4}}>
                <span style={{background:c.bg,color:c.co,borderRadius:8,padding:"2px 10px",fontSize:12,fontWeight:700}}>{b.status}</span>
                <b>{b.time} (ኢ.ሰ: {toEthTime(b.time)})</b>
              </div>
              <b style={{fontSize:15}}>{b.customerName}</b>
              <p style={S.hlp}>{b.customerPhone} · {b.people} person{b.people>1?"s":""}</p>
              <p style={S.hlp}>{b.serviceName} · {b.durationMins}min</p>
              {b.notes&&<p style={{...S.hlp,fontStyle:"italic"}}>"{b.notes}"</p>}
            ...
            <div style={{display:"flex",flexDirection:"column",gap:5}}>
              {user.role!=="supervisor"&&<>
                ...
                {b.status==="Arrived"&&<span style={{color:"#166534",fontWeight:700,fontSize:13}}>✓ Checked In</span>}
              ...
              {user.role==="supervisor"&&b.status==="Arrived"&&<span style={{color:"#166534",fontWeight:700,fontSize:13}}>✓ Checked In</span>}
            </div>
          </div>
        );})}
        <HR/>
        <h3 style={S.sh}>Upcoming 7 Days</h3>
      ...
      {tab==="Service Setup"&&<section style={S.card}>
        <h2 style={S.ct}>Service & Price Management</h2>
        <div style={{display:"grid",gridTemplateColumns:sc.mob?"1fr":"1fr 1fr",gap:20,marginBottom:16}}>
          <div>
            <h3 style={S.sh}>Categories</h3>
            <div style={S.r2}><input style={S.inp} value={newCat} onChange={e=>setNewCat(e.target.value)} placeholder="New category" onKeyDown={e=>e.key==="Enter"&&addCat()}/><button style={S.btnS} onClick={addCat}>+ Add</button></div>
            <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>{cats.map(c=><span key={c} style={{background:"#f5e7c0",color:"#6b4c11",borderRadius:14,padding:"2px 10px",fontSize:11,fontWeight:700}}>{c}</span>)}</div>
          </div>
          <div>
            <h3 style={S.sh}>Add Service</h3>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
              ...
              <label style={{display:"flex",alignItems:"center",gap:6,fontSize:12}}><input type="checkbox" checked={nSvc.bookable} onChange={e=>setNSvc({...nSvc,bookable:e.target.checked})}/> Bookable (Spa only)</label>
              <button style={{...S.btnP,gridColumn:"1/-1"}} onClick={addSvc2}>+ Add Service</button>
            </div>
          </div>
        </div>
        <HR/>
        <h3 style={S.sh}>Price List ({svcs.length} services)</h3>
        ...
        <div style={{overflowX:"auto"}}>
          <div style={{display:"grid",gridTemplateColumns:"90px 80px 1fr 80px 50px 60px 46px 34px",gap:4,padding:"5px 8px",background:"#f5e7c0",borderRadius:10,marginBottom:6,fontSize:11,fontWeight:800,color:"#6b4c11",minWidth:600}}>
            <span>Cat</span><span>Sub</span><span>Name</span><span>Price</span><span>Cm%</span><span>Min</span><span>Book</span><span></span>
          </div>
          {(svcF==="All"?svcs:svcs.filter(s=>s.category===svcF)).map(s=><div key={s.id} style={{display:"grid",gridTemplateColumns:"90px 80px 1fr 80px 50px 60px 46px 34px",gap:4,padding:"5px 8px",background:"#fffaf2",borderRadius:10,marginBottom:4,alignItems:"center",border:"1px solid #ecdba3",minWidth:600}}>
            <span style={{fontSize:10,fontWeight:700,color:"#6b4c11",overflow:"hidden"}}>{s.category}</span>
      ...
      {tab==="Daily Closing"&&<section style={S.card}>
        <h2 style={S.ct}>Daily Closing Report</h2>
        <div style={{display:"flex",alignItems:"flex-end",gap:12,marginBottom:18,flexWrap:"wrap"}}>
          <EthPicker label="Date" value={clDate} onChange={setClDate}/>
        ...
        <div style={{display:"grid",gridTemplateColumns:sc.mob?"1fr 1fr":"repeat(4,1fr)",gap:10,marginBottom:12}}>
          ...
          <SC label="Transfer/Card"    value={money(clTr)}/>
          <SC label="Tips Collected"   value={money(clTips)}/>
          <SC label="Daily Expenses"   value={money(clDE)}   accent/>
        ...
        <p style={S.hlp}>Net Cash = Cash In − Tips − Daily Expenses. Grand Total = Net Cash + Transfer.</p>
        <HR/><h3 style={S.sh}>Tips by Employee</h3>
        {clTipBr.length===0?<p style={S.hlp}>No tips recorded.</p>:clTipBr.map(t=><div key={t.employee} style={S.li}><span>{t.employee}</span><b>{money(t.amount)}</b></div>)}
        <HR/><h3 style={S.sh}>Daily Expenses</h3>
        {clE.length===0?<p style={S.hlp}>None recorded.</p>:clE.map(e=><div key={e.id} style={S.li}><span>{e.name} × {e.qty}</span><b>{money(e.total)}</b></div>)}
        <HR/><h3 style={S.sh}>Paid Visits ({clV.filter(v=>v.status==="Paid & Closed").length})</h3>
        {clV.filter(v=>v.status==="Paid & Closed").map(v=><div key={v.id} style={S.li}><span>#{v.queue} — {v.name}</span><span style={{display:"flex",gap:10,alignItems:"center"}}><span style={S.hlp}>{v.paymentMethod}</span><b>{money(v.totalService)}</b></span></div>)}
      </section>}

      {tab==="Expenses"&&<section style={S.card}>
        <h2 style={S.ct}>General Expense Management</h2>
        <p style={S.hlp}>For restocking, maintenance, utilities — separate from daily service expenses.</p>
        <div style={{display:"grid",gridTemplateColumns:sc.mob?"1fr":"1fr 1fr 1fr 1fr",gap:10,marginBottom:10}}>
          ...
          <div><L>Reason</L><input style={S.inp} value={gRsn} onChange={e=>setGRsn(e.target.value)} placeholder="Optional reason"/></div>
          <div><L>Amount (Birr)</L><input style={S.inp} type="number" value={gAmt} onChange={e=>setGAmt(e.target.value)} placeholder="0"/></div>
        </div>
        <button style={S.btnP} onClick={addGE}>Save Expense</button>
        <HR/>
        <div style={S.tb}><span>All-Time General Expenses Total</span><b>{money(exps.filter(e=>e.type==="General").reduce((s,e)=>s+Number(e.total||0),0))}</b></div>
        <HR/>
        {exps.filter(e=>e.type==="General").sort((a,b)=>b.date.localeCompare(a.date)).map(e=><div key={e.id} style={S.li}>
          <div><b>{e.name}</b>{e.reason&&<p style={S.hlp}>{e.reason}</p>}<p style={{...S.hlp,fontSize:10}}>{e.date}</p></div>
          <span style={{display:"flex",alignItems:"center",gap:8}}><b>{money(e.total)}</b><button style={S.btnD} onClick={()=>delE(e.id)}>×</button></span>
        </div>)}
      </section>}

      {tab==="Customers"&&<section style={S.card}>
        <h2 style={S.ct}>Customer Database</h2>
        ...
        {fCusts.map(c=>{
          ...
          return(<div key={c.id} style={S.li}>
            <div>
              <b style={{fontSize:15}}>{c.name}</b>
              <p style={S.hlp}>{c.phone} · ID: {c.id}</p>
              <p style={S.hlp}>Favourite: {fav}</p>
              <p style={S.hlp}>{cbks.length} bookings · {cv.length} visits · {money(spent)} total</p>
            </div>
            <button style={S.btnD} onClick={()=>delCust(c.id)}>Delete</button>
          </div>);
        })}
      </section>}

      {tab==="Payroll"&&<section style={S.card}>
        <h2 style={S.ct}>Payroll Management</h2>
        ...
        <div style={{background:"#fef9ec",border:"1px solid #e0b85a",borderRadius:11,padding:12,marginBottom:14,fontSize:13}}>Commissions update live. Click Close & Pay Period to freeze this period and reset deductions for the next one.</div>
        ...
        <label style={{display:"flex",alignItems:"center",gap:6,fontSize:12,cursor:"pointer",marginBottom:10}}><input type="checkbox" checked={showFired} onChange={e=>setShowFired(e.target.checked)}/> Show inactive employees</label>
        {emps.filter(e=>showFired||e.active).map(emp=>{
          const extra=empC.find(e=>e.id===emp.id);
          const daily=Number(emp.salary||0)/30;const absDed=daily*Number(emp.absentDays||0);
          ...
          return(<div key={emp.id} style={{background:"#fffaf2",border:"1px solid #ecdba3",borderRadius:14,padding:14,marginBottom:10,opacity:emp.active?1:0.6}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10,flexWrap:"wrap",gap:8}}>
              <div>
                <b style={{fontSize:15}}>{emp.name}</b>
                <span style={{background:"#f5e7c0",color:"#6b4c11",borderRadius:14,padding:"2px 10px",fontSize:11,fontWeight:700,marginLeft:8}}>{emp.section}</span>
                {!emp.active&&<span style={{background:"#fee2e2",color:"#991b1b",borderRadius:14,padding:"2px 10px",fontSize:11,fontWeight:700,marginLeft:6}}>INACTIVE</span>}
              </div>
            ...
            {extra?.breakdown?.length>0&&<details style={{marginBottom:8}}>
              <summary style={{...S.hlp,cursor:"pointer",fontWeight:700}}>Commission Breakdown ({extra.breakdown.length} services)</summary>
              <div style={{paddingLeft:10,paddingTop:4}}>{extra.breakdown.map((b,i)=><div key={i} style={{display:"flex",justifyContent:"space-between",fontSize:12,borderBottom:"1px solid #ecdba3",padding:"2px 0"}}><span>{b.name}</span><span>{money(b.income)} → {money(b.commission)}</span></div>)}</div>
            </details>}
            <div style={{...S.tb,padding:"10px 16px"}}><span>Net Pay This Period</span><b style={{fontSize:16}}>{money(Math.max(0,Math.round(net)))}</b></div>
          </div>);
        })}
        {periods.length>0&&<><HR/><h3 style={S.sh}>Closed Period History</h3>
          {periods.slice().reverse().map((cp,i)=><details key={i} style={{...S.li,display:"block",marginBottom:8}}>
            <summary style={{cursor:"pointer",fontWeight:700}}>{cp.period} <span style={S.hlp}>({new Date(cp.closedAt).toLocaleDateString()})</span></summary>
            <div style={{paddingTop:8}}>{cp.employees?.map(e=>{const dd=Number(e.salary||0)/30;const ad=dd*Number(e.absentDays||0);const n=Number(e.salary||0)+Number(e.commissionTotal||0)-Number(e.loan||0)-Number(e.brokerFee||0)-Number(e.otherDeduction||0)-ad;return<div key={e.id} style={{display:"flex",justifyContent:"space-between",padding:"4px 0",borderBottom:"1px solid #ecdba3",fontSize:13}}><span><b>{e.name}</b> ({e.section})</span><b>{money(Math.max(0,Math.round(n)))}</b></div>;})}
            </div>
          </details>)}
        </>}
      ...
      {tab==="Dashboard"&&<section style={S.card}>
        <h2 style={S.ct}>Manager Dashboard</h2>
      ...
      {tab==="Staff"&&<section style={S.card}>
        <h2 style={S.ct}>Staff & Password Management</h2>
        <p style={S.hlp}>Reception: Reception + Checkout + Bookings. Supervisor: Supervisor + Bookings. Manager: All tabs.</p>
        <HR/>
        <h3 style={S.sh}>{editStaff?"Edit Account":"Add / Update Staff Account"}</h3>
        <div style={{display:"grid",gridTemplateColumns:sc.mob?"1fr":"1fr 1fr 1fr 1fr auto",gap:8,marginBottom:14}}>
          <div><L>Username (login ID)</L><input style={S.inp} value={nStaff.id} onChange={e=>setNStaff(p=>({...p,id:e.target.value}))} placeholder="e.g. reception1" disabled={!!editStaff}/></div>
          ...
          <div><L>Password</L><input style={S.inp} type="password" value={nStaff.password} onChange={e=>setNStaff(p=>({...p,password:e.target.value}))} placeholder="New password"/></div>
        ...
        <HR/><h3 style={S.sh}>All Staff Accounts</h3>
        {staff.map(s=><div key={s.id} style={{...S.li,flexWrap:"wrap",gap:10,opacity:s.active?1:0.55}}>
          <div>
            <b style={{fontSize:15}}>{s.name}</b>
            <span style={{background:"#f5e7c0",color:"#6b4c11",borderRadius:14,padding:"2px 10px",fontSize:11,fontWeight:700,marginLeft:8}}>{s.role}</span>
            {!s.active&&<span style={{background:"#fee2e2",color:"#991b1b",borderRadius:14,padding:"2px 10px",fontSize:11,fontWeight:700,marginLeft:6}}>INACTIVE</span>}
            <p style={S.hlp}>Username: <b>{s.id}</b></p>
          </div>
          <div style={{display:"flex",gap:6,flexWrap:"wrap",alignItems:"center"}}>
            <button style={S.btnS} onClick={()=>{setEditStaff(s);setNStaff({id:s.id,name:s.name,role:s.role,password:""});}}>Edit / Reset PW</button>
            <button style={s.active?S.btnD:S.btnS} onClick={()=>setStaffAct(s.id,!s.active)}>{s.active?"Deactivate":"Reactivate"}</button>
          </div>
        </div>)}
      </section>}

      {tab==="Activity Log"&&<section style={S.card}>
        <h2 style={S.ct}>Activity Log</h2>
        <p style={S.hlp}>Last 100 recorded actions across all staff members.</p>
        <HR/>
        ...
        {actLog.map((a,i)=><div key={i} style={S.li}>
          ...
          <div style={{textAlign:"right",flexShrink:0}}>
            <span style={{background:"#f5e7c0",color:"#6b4c11",borderRadius:8,padding:"2px 8px",fontSize:11,fontWeight:700}}>{a.staff_name}</span>
            <p style={{...S.hlp,fontSize:10,marginTop:4}}>{a.ts?new Date(a.ts).toLocaleString():""}</p>
          </div>
        </div>)}
      </section>}
...
function SLines({visit,emps,mode,onUpd,onRem}){
  ...
  // FIXED: locked when Ready for Payment or Paid — status/employee fields disabled for completed services
  ...
  return(<div style={{marginBottom:14}}>
    ...
    {visit.services.map(line=>{
      ...
      const lineDone=["Completed","Cancelled"].includes(line.status);
      return(<div key={line.lineId} style={{background:lineDone?"#f8f9fa":"#fffaf2",border:"1px solid #ecdba3",borderRadius:12,padding:10,marginBottom:7}}>
        <div style={{display:"flex",justifyContent:"space-between",marginBottom:7,flexWrap:"wrap",gap:6}}>
          <div>
            <b style={{fontSize:14}}>{line.name}</b>
            <p style={{color:"#6b4c11",fontSize:11,margin:"2px 0"}}>{line.sub} · {isSv?money(line.price)+" × "+line.qty+" = "+money(lineGross(line)):"Gross: "+money(lineGross(line))+" | Income: "+money(lineIncome(line))}</p>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"flex-end"}}>
          <div>
            <p style={{fontSize:10,fontWeight:700,color:"#6b4c11",margin:"0 0 2px"}}>Qty</p>
            <input style={{width:55,padding:"6px 8px",borderRadius:8,border:"1px solid #c7b06a",background:"#fff",fontSize:12}} type="number" min="1" value={line.qty} onChange={e=>onUpd(line.lineId,"qty",e.target.value)} disabled={locked}/>
          </div>
          {!isSv&&<>
            <div>
              <p style={{fontSize:10,fontWeight:700,color:"#6b4c11",margin:"0 0 2px"}}>Discount</p>
              <input style={{width:80,padding:"6px 8px",borderRadius:8,border:"1px solid #c7b06a",background:"#fff",fontSize:12}} type="number" value={line.discount} onChange={e=>onUpd(line.lineId,"discount",e.target.value)} disabled={locked}/>
            </div>
            <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:2}}>
              <p style={{fontSize:10,fontWeight:700,color:"#6b4c11",margin:0}}>Free</p>
              <input type="checkbox" checked={line.free} onChange={e=>onUpd(line.lineId,"free",e.target.checked)} disabled={locked} style={{width:16,height:16}}/>
            </div>
          </>}
          <div>
            <p style={{fontSize:10,fontWeight:700,color:"#6b4c11",margin:"0 0 2px"}}>Preferred</p>
            <select style={{padding:"6px 8px",borderRadius:8,border:"1px solid #c7b06a",background:"#fff",fontSize:12}} value={line.preferredEmployee} onChange={e=>onUpd(line.lineId,"preferredEmployee",e.target.value)} disabled={locked}>
              <option value="">None</option>{elig.map(e=><option key={e.id}>{e.name}</option>)}
            </select>
          </div>
          <div>
            <p style={{fontSize:10,fontWeight:700,color:"#6b4c11",margin:"0 0 2px"}}>Who Did It?</p>
            <select style={{padding:"6px 8px",borderRadius:8,border:"1px solid #c7b06a",background:"#fff",fontSize:12}} value={line.employee} onChange={e=>onUpd(line.lineId,"employee",e.target.value)} disabled={locked}>
              <option value="">Select</option>{elig.map(e=><option key={e.id}>{e.name}</option>)}
            </select>
          </div>
          <div>
            <p style={{fontSize:10,fontWeight:700,color:"#6b4c11",margin:"0 0 2px"}}>Status</p>
            <select style={{padding:"6px 8px",borderRadius:8,border:"1px solid #c7b06a",background:"#fff",fontSize:12,background:lineDone?"#f0fdf4":"#fff"}} value={line.status} onChange={e=>onUpd(line.lineId,"status",e.target.value)} disabled={locked}>
              <option>Waiting</option><option>In Progress</option><option>Completed</option><option>Cancelled</option>
            </select>
          </div>
        </div>
      </div>);
...
function PS({emps,empC,period}){return(<div style={{fontFamily:"Arial,sans-serif",padding:32}}>
  <div style={{textAlign:"center",marginBottom:20}}><h1 style={{margin:0}}>Ambar Spa & Beauty</h1><h2 style={{margin:"4px 0 0",fontWeight:400}}>Payroll Sheet — {period.label}</h2><p style={{fontSize:11,color:"#666"}}>Printed: {new Date().toLocaleString()}</p></div>
  <table style={{width:"100%",borderCollapse:"collapse",fontSize:12}}>
    <thead><tr style={{background:"#e0b85a"}}>{["Employee","Section","Base Salary","Commission","Absent Ded.","Loan","Broker Fee","Other","NET PAY"].map(h=><th key={h} style={{border:"1px solid #999",padding:"7px 9px",textAlign:"left"}}>{h}</th>)}</tr></thead>
    <tbody>{emps.filter(e=>e.active).map((emp,i)=>{const ex=empC.find(e=>e.id===emp.id);const d=Number(emp.salary||0)/30;const ad=d*Number(emp.absentDays||0);const net=Number(emp.salary||0)+Number(ex?.commissionTotal||0)-Number(emp.loan||0)-Number(emp.brokerFee||0)-Number(emp.otherDeduction||0)-ad;return(
      <tr key={emp.id} style={{background:i%2===0?"#fff":"#fffaf2"}}>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{emp.name}</td>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{emp.section}</td>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{Number(emp.salary||0).toLocaleString()}</td>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{Number(ex?.commissionTotal||0).toLocaleString()}</td>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{Math.round(ad).toLocaleString()}</td>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{Number(emp.loan||0).toLocaleString()}{emp.loanNote?" ("+emp.loanNote+")":""}</td>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{Number(emp.brokerFee||0).toLocaleString()}</td>
        <td style={{border:"1px solid #ddd",padding:"6px 9px"}}>{Number(emp.otherDeduction||0).toLocaleString()}{emp.otherNote?" ("+emp.otherNote+")":""}</td>
...
const S={
  ...
  tab:   {padding:"9px 4px",borderRadius:10,border:"1px solid #e0b85a",background:"#fff",color:"#111827",fontWeight:700,cursor:"pointer",fontSize:11,transition:"all .15s"},
